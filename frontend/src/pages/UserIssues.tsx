  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-sm text-slate-600">Track the accessibility concerns you have submitted.</p>
      </div>

      <div className="grid gap-5 lg:grid-cols-2">
        {mockIssues.map((issue) => (
          <article key={issue.id} className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
            {issue.imageUrl && (
            ...
            <div className="p-6">
              ...
              <div className="mt-4 space-y-1 text-sm text-slate-500">
                ...
                <p><strong>Reported:</strong> {issue.createdAt}</p>
              </div>
